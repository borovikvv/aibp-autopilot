...
- Активны 11 джоб: stage-контур + прод-генерации (Morning/Weekly Case/
  Evening) + Safety Check. На паузе до этапа 9: miner, policy updater,
  shadow runner, decision engine, rollback check, approval gate; redirect
  health — до монетизации. `autopilot_paused: true`.
